...
from .translation_xp import TranslationXP, ModelArguments, TranslationDataTrainingArguments
...
class TranslationSparseXP(SparseXP, TranslationXP):
    ...
    @classmethod
    def final_finetune(cls, src_path, dest_path, task, source_lang, target_lang, dataset_config_name=None, teacher=None):
        param_dict = {
